...
# import tkinter 
from tkinter import *
# building the neccessay functions
...
input_frame = Frame(root,width= 312,height = 12,bd =0, highlightbackground = "black",highlightcolor = "black",highlightthickness =1)
input_frame.pack(side= TOP)

input_field = Entry(input_frame,font = ('arial',18,'bold'),textvariable = input_text, width= 50, bg = "powder blue",bd = 7, justify = "right")
